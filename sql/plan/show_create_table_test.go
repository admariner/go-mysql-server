...
func TestShowCreateTable(t *testing.T) {
	...
	table := memory.NewTable(
		...
		sql.Schema{
			...
			&sql.Column{Name: "zab", Type: sql.Int32, Default: sql.MustStringToColumnDefaultValue(ctx, "0"), Nullable: true, PrimaryKey: true},
			&sql.Column{Name: "bza", Type: sql.Uint64, Default: sql.MustStringToColumnDefaultValue(ctx, "0"), Nullable: true, Comment: "hello"},
...
func TestShowCreateTableWithIndexAndForeignKeys(t *testing.T) {
	...
	table := memory.NewTable(
		...
		sql.Schema{
			...
			&sql.Column{Name: "zab", Source: "test-table", Type: sql.Int32, Default: sql.MustStringToColumnDefaultValue(ctx, "0"), Nullable: true, PrimaryKey: true},
			&sql.Column{Name: "bza", Source: "test-table", Type: sql.Uint64, Default: sql.MustStringToColumnDefaultValue(ctx, "0"), Nullable: true, Comment: "hello"},

...
func newTableTest(source string) sql.Table {
	schema := []*sql.Column{
		{Name: "col1", Type: sql.Int32, Source: source, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), "0"), Nullable: false},
		{Name: "col2", Type: sql.Int64, Source: source, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), "0"), Nullable: false},
		{Name: "col3", Type: sql.Text, Source: source, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), `""`), Nullable: false},
	}

...
var tests = []struct {
...
}{
	{
		name: "test",
		schema: sql.Schema{
			&sql.Column{Name: "col1", Source: "test", Type: sql.Text, Nullable: false, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), `""`)},
			&sql.Column{Name: "col2", Source: "test", Type: sql.Int32, Nullable: false, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), "0")},
			&sql.Column{Name: "col3", Source: "test", Type: sql.Int64, Nullable: false, Default: sql.MustStringToColumnDefaultValue(sql.NewEmptyContext(), "0")},
		},
		numPartitions: 2,
		rows: []sql.Row{
